...
/**
 * @brief Print the candidate size, the number of questions asked and the time cost
 * @param out_cp  The txt file
 * @param Csize   The candidate size
...
/**
 * @brief Calculate the difference of the two scores
